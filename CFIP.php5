    ...
    <form action="/CFIP1.php5" method="post" name="ts" target="_parent">
      ...
      <table style="width: 740px;" align="center">
        <tbody>
          <tr>
            ...
            <td style="text-align: left;">
              <select required="required" name="Echelon">
			    <option selected="selected" value="38">Contrôleur stagiaire 1er échelon</option>
                <option value="39">Contrôleur stagiaire 2ème échelon</option>
                <option value="40">Contrôleur stagiaire 3ème échelon</option>
                <option value="41">Contrôleur stagiaire 4ème échelon</option>
                <option value="42">Contrôleur stagiaire 5ème échelon</option>
                <option value="43">Contrôleur stagiaire 6ème échelon</option>
                <option value="44">Contrôleur stagiaire 7ème échelon</option>
                <option value="45">Contrôleur stagiaire 8ème échelon</option>
                <option value="46">Contrôleur stagiaire 9ème échelon</option>
                <option value="47">Contrôleur stagiaire 10ème échelon</option>
                <option value="48">Contrôleur stagiaire 11ème échelon</option>
                <option value="49">Contrôleur stagiaire 12ème échelon </option>
                <option value="50">Contrôleur stagiaire 13ème échelon</option>
                <option value="1">Contrôleur 2ème classe 1er échelon</option>
		  ...
		  <tr>
            <td style="text-align: right;">Provenance des stagiaires<br>
            </td>
            <td style="width: 137.166px;">
              <select required="required" name="Stag">
			  <option selected="selected" value="0">Externe sans reprise d'ancienneté</option>
                ...
                <option value="3">Interne Ex-Cat C AA1</option>     
				<option value="4">Interne ex-Cat C AA2</option>    
              </select>
              <br>
            </td>
