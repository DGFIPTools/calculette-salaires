...
$PC=$Traitement_indiciaire*0.0954;
$RIMT=11.98*2;
$CSG=0.075*$Traitement_Brut*98.25/100;
$CRDS=0.005*$Traitement_Brut*98.25/100;
$RAFP=0.05*($IMT+$IAT+$PR+$ACF+$IR+$TAI);



$Total_net=$Traitement_Brut-($PC+$RIMT+$CSG+$CRDS+$RAFP);
$Total_retenues=$PC+$CSG+$CRDS+$RIMT+$RAFP;
    ...
    <table style="width: 691px; height: 404px;" border="0" align="center">
      <tbody>
	   ...
	   <tr>
          ...
          <td style="background-color: #ff8f8c; margin-left: -288px; text-align: center;"><font size="3" face="Arial, Helvetica, sans-serif" color=#FFFFFF>A
            PAYER</td>
          <td style="background-color: #ff8f8c; text-align: center;"><font size="3" face="Arial, Helvetica, sans-serif" color=#FFFFFF>A DEDUIRE</td>
        </tr>
        <tr>
          <td style="background-color: #ffffcc;"><font size="1" face="Arial, Helvetica, sans-serif">TRAITEMENT BRUT</td>
          <td style="background-color: #ffcccc; width: 177.583px; text-align: center;"><?php echo "$Traitement_indiciaire"; ?><br>
          </td>
        ...
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$PC"; ?><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$RIMT"; ?><br>
          </td>
        </tr>
        <tr>
          <td><font size="1" face="Arial, Helvetica, sans-serif">SFT</td>
          <td style="background-color: #ffcccc;"><br>
          </td>
          <td style="background-color: #ffcccc;text-align: center;">XXX<br>
          </td>
        </tr>
        <tr>
          <td style="background-color: #ffffcc;"><font size="1" face="Arial, Helvetica, sans-serif">IMT</td>
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$IMT"; ?><br>
          </td>
          <td style="background-color: #ffcccc;"><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$IAT"; ?><br>
          </td>
          <td style="background-color: #ffcccc;text-align: center;"><br>
          </td>
        </tr>
        <tr>
          <td style="background-color: #ffffcc;"><font size="1" face="Arial, Helvetica, sans-serif">ACF Technicité</td>
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$ACF"; ?><br>
          </td>
          <td style="background-color: #ffcccc;text-align: center;"><br>
          </td>
        </tr>
        <tr style="height: 24.2px;">
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$PR"; ?><br>
          </td>
          <td style="background-color: #ffcccc;text-align: center;"><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$IR"; ?><br>
          </td>
          <td style="background-color: #ffcccc;"><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$CSG"; ?><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$CRDS"; ?><br>
          </td>
        </tr>
        <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$RAFP"; ?><br>
          </td>
        </tr>
		 <tr>
          ...
          <td style="background-color: #ffcccc;text-align: center;"><?php echo "$TAI"; ?><br>
          </td>
        </tr>
   
        <tr>
          <td style="background-color: #ff8f8c;"><font size="3" face="Arial, Helvetica, sans-serif" color=#FFFFFF>TOTAUX</td>
          <td style="background-color: #ff8f8c;text-align: center;"><?php echo "$Traitement_Brut"; ?><br>
          </td>
          <td style="background-color: #ff8f8c;text-align: center;"><?php echo "$Total_retenues"; ?><br>
          </td>
        </tr>
        <tr>
          <td><br>
        ...
        <tr>
          <td style="background-color: #ff8f8c;"><font size="4" face="Arial, Helvetica, sans-serif" color=#FFFFFF>NET A PAYER</td>
          <td style="background-color: #ff8f8c;"><br>
          </td>
          <td style="background-color: #ff8f8c;text-align: center;"><font size="4" face="Arial, Helvetica, sans-serif" color=#FFFFFF><?php echo "$Total_net"; ?><br>
          </td>
        </tr></font>
      </tbody>
    </table>
...
Version 1.1  Ajout choix TAI prog/PSE
<br>
Version 1.0  Ajout de la TAI
<br>
