...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8"/>
  ...
  <body>
	...
	<input type="hidden" name="data_xml" value="aafip">
     ...
     <h5 class="titleForm">&nbsp; Estimation de votre salaire&nbsp;</h5>
	  ...
	  $gradeId=(max($_GET['grade']-1,0));
		...
		$formObjectsArray = array($gradeClass,$echelonClass,$taiClass,$rifClass,$irClass,$quotiteClass,$pSourceClass);
